<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="SuaSanPham.aspx.cs" Inherits="ban_my_pham.admin.SuaSanPham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        ...
        <div class="form-control">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" Display="None" ControlToValidate="txtNgaySanXuat" ErrorMessage="Ngày sản xuất không được bỏ trống."></asp:RequiredFieldValidator>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="None" ControlToValidate="txtPhanTramGiamGia" ErrorMessage="Giá bán không được bỏ trống."></asp:RequiredFieldValidator>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="ddlLoaiSanPham" class="label">Loại sản phẩm</label>
    ...
    <div class="form-group">
        ...
        <input runat="server" class="form-control" type="number" step="any" id="txtPhanTramGiamGia" value="1" min="0" max="100" />
    </div>
    <div class="form-group">
