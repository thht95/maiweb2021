<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="ThemMaGiamGia.aspx.cs" Inherits="ban_my_pham.admin.ThemMaGiamGia" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 style="text-align: center">Thêm mã giảm giá</h2>
    ...
    <div class="form-group">
        ...
        <input runat="server" class="form-control" type="number" step="any" id="txtPhanTramGiamGia" value="1" />
    </div>
    ...
    <div class="center-children">
        <asp:Button CssClass="button" ID="btnThem" runat="server" Text="Thêm" />
